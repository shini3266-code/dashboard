...
export default function MemoSidebar({ memos, categories, filtered, selected, selectedCategory, loading, onSelect, onNew, onCategoryChange, onShowCatModal, onShowTrash, trashedCount, showTrash }: {
  memos: Memo[]
  categories: Category[]
  filtered: Memo[]
  selected: Memo | null

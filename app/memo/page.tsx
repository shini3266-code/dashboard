        ...
        {isEditing ? (
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: 24, gap: 12 }}>
            ...
            <textarea
              ...
              style={{
                flex: 1, background: 'var(--surface)', border: '1px solid var(--border)',
                borderRadius: 8, padding: '16px', color: 'var(--text)', fontSize: '0.7rem',
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: 24, overflow: 'auto' }}>
            ...
            <div style={{ flex: 1, fontSize: '0.7rem', lineHeight: 1.9, color: 'var(--text)', whiteSpace: 'pre-wrap', borderTop: '1px solid var(--border)', paddingTop: 16 }}>
              {selected.content}
            </div>
          </div>
        ) : (
          <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--muted)', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={{ fontSize: '0.7rem' }}>메모를 선택하거나 새 메모를 작성하세요</div>
          </div>
        )}
      </div>
    </div>

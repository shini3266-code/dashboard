    ...
    <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
            <button
              ...
              style={{ background: 'none', border: '1px solid var(--border)', borderRadius: 6, padding: '5px 12px', color: 'var(--muted)', cursor: 'pointer', fontSize: '0.6rem'}}
            >
              취소
            </button>
            <button
              onClick={addEvent}
              style={{ background: 'var(--accent)', color: '#fff', border: 'none', borderRadius: 6, padding: '5px 12px', cursor: 'pointer', fontSize: '0.6rem', fontWeight: 700 }}
            >
              저장
            </button>
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: 16 }}>
        ...
        <div>
          ...
          {loadingDb ? (
            <div style={{ color: 'var(--muted)', fontSize: '0.6rem', textAlign: 'center', padding: 20 }}>
              로딩 중...
            </div>
              ...
              return (
                <div key={ev.id} style={{
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div style={{ fontSize: '0.6rem', fontWeight: 700, color: 'var(--text)' }}>
                      {ev.title}
                    </div>
                    <div style={{
                      fontSize: '0.6rem',
